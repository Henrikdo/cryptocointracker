...
class _HomeScreenState extends State<HomeScreen> {
  ...
  @override
  void initState() {
    _foundcoins = controller.coinsList;
    super.initState();
  }
  ...
  void _runfilter(String enteredKeyword){
    ...
    if(enteredKeyword.isEmpty){
      results = controller.coinsList;
    }else{
      results = controller.coinsList.where((coin)=>coin.name.toLowerCase().contains(enteredKeyword.toLowerCase())).toList().obs;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('Crypto Tracker',style: textStyle(25,Colors.white,FontWeight.w400))),
      ),
                ...
                Obx(
                  ()=>  controller.isLoading.value
                   ?  Center(
                    ...
                    itemCount: _foundcoins.length,
                    itemBuilder: (context,index) {
                      
                      double priceChange24H = _foundcoins[index].marketCapChangePercentage24H;
                      Color percentageColor = priceChange24H < 0 ?  Colors.red: Colors.green;
                    
                      return Column(
                        key: ValueKey(_foundcoins[index].id),
                        children: [
                          Padding(
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text('\$${_foundcoins[index].currentPrice}',
                                          style: textStyle(18, Colors.black, FontWeight.w200),
                                          overflow: TextOverflow.fade,
                                          softWrap: false,
                                          maxLines: 1,
                                          ),
                                          Text(_foundcoins[index].symbol.toUpperCase(),
